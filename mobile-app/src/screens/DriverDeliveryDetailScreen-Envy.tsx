...
import deliveryService, { Delivery, Stop } from '../services/deliveryService';
...
const DriverDeliveryDetailScreen: React.FC = () => {
  ...
  const handleCompleteStop = async () => {
    ...
    try {
      ...
      // Use the exact same field structure as web app
      ...
      console.log('Completing stop with data structure matching web app:', {
