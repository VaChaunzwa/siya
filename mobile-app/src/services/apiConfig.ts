...
const API_BASE_URL = __DEV__
  ? "http://10.0.0.20:5006/api" // Development server - Use machine IP for mobile access
  : "https://siya-portal.web.app/api"; // Production server - Firebase Hosting
...
export const API_ENDPOINTS = {
  ...
  DRIVER_CHECKLISTS: (driverId: string) =>
    `/vehicle-checklists/driver/${driverId}`,
};
